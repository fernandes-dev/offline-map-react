...
function CheckpointMarker({marker, checkPointDetails, positionToCompare, onClick}: ICheckpointMarkerProps) {
  ...
  return (
    <Marker
      ...
      icon={
        new Icon({
          iconUrl: distanceInMeters > 10 ? 'https://i.imgur.com/yxwt71l.png' : 'https://i.imgur.com/yw4QRVk.png',
          iconSize: [25, 25],
        })
      }
      title={marker.text}
