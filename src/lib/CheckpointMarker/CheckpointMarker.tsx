...
function CheckpointMarker({marker, checkPointDetails, positionToCompare, onClick, greenCheckpoint}: ICheckpointMarkerProps) {
  ...
  return (
    <Marker
      ...
      icon={
        new Icon({
          iconUrl: greenCheckpoint ? 'https://i.imgur.com/yw4QRVk.png' : 'https://i.imgur.com/yxwt71l.png',
          iconSize: [25, 25],
        })
      }
      title={marker.text}
